				...
				<div className="mx-auto max-w-6xl px-4">
					<div className="rounded-3xl bg-ivory/30 px-4 py-8 mb-10 shadow-xl backdrop-blur-md sm:px-8">
						...
						<div className="grid gap-8 md:grid-cols-2 items-center">
										...
										{highlightPhotos.map((_, index) => (
											<button
												...
												className={`h-1.5 rounded-full transition-all ${
													index === photoIndex ? "w-6 bg-aqua" : "w-2 bg-silver/60"
												}`}
							...
							<div className="space-y-3 text-lg text-gray">
								<dl className="space-y-2">
									...
									<div className="flex gap-2">
										<dt className="w-16 shrink-0  font-semibold">對象</dt>
										{campInfo.targetAudience}
									</div>
									<div className="flex gap-2">
										<dt className="w-16 shrink-0  font-semibold">住宿</dt>
										美亞商旅 臺北市中正區忠孝西路一段 50 號
									</div>
									<div className="flex gap-2">
										<dt className="w-16 shrink-0  font-semibold">費用</dt>
										一般生 13000 / 清寒生 6500
									</div>
								</dl>
							</div>
						...
						<div className="mt-10 border-t border-silver/40 pt-6 flex flex-wrap gap-3 text-md items-center">
							<p className="text-sm font-semibold tracking-wide text-gray/80">想先了解更多？</p>
							<Link
								href="/activities"
								onClick={() =>
