...
const highlightPhotos = [
  { src: "/globe.svg", alt: "歷屆營隊花絮 1" },
  { src: "/file.svg", alt: "歷屆營隊花絮 2" },
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen text-foreground">
      ...
      <section className="relative bg-[url('/background.png')] lg:bg-[length:70%_auto] bg-[length:100%_auto] lg:bg-right bg-center bg-fixed bg-no-repeat">
        <div className="relative z-10 flex min-h-screen max-w-2xl flex-col justify-center px-4 text-ivory ">
          <img src="/title.png" alt="Title" className="w-3/4 sm:w-3/4 md:w-7/8" />
